         ...
         <div class="product-details">
               ...
               <ul class="product-list">
                  <li class="product-list__item text-heading">
                     <a
                        ...
                        class="link text-body hover-text-main hover-text-decoration-underline">
                        Fira Sans
                     </a>
                  </li>
                  <li class="product-list__item text-heading">
            ...
            <div class="more-item">
               <div class="flx-between mb-4">
                  ...
                  <a
                     href="profile.html"
                     class="text-heading fw-500 hover-text-decoration-underline">
                     View Author Profile
                  </a>
               </div>
               <div class="more-item__content flx-align">
                  <div class="more-item__item">
                     <a
                        ...
                        class="link w-100 h-100 d-block">
